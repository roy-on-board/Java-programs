...
public class DiffOddEven {
    ...
    // difference() will calculate the difference between sum of odd and even levels
    // of binary tree
    public int difference() {
        ...
        if (root == null) {
            ...
            while (queue.size() != 0) {
                ...
                // Variable nodesInLevel will hold the size of queue i.e. number of elements in
                // queue
